...
class OrderGateway {
  ...
  async participate(subContract, makerData, takerData, taker) {
    ...
    gas = 4000000; //TODO: Gas cost is causing issues across many usages of this function.  This needs to be further investigated. Hard coding ot mitigate teh issue for now.
